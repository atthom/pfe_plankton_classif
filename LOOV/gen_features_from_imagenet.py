...
def fit_data(model):
    ...
    bottleneck_features_train = model.predict_generator(generator, nb_img // (2* batch_size))
    np.save(open('E:/Polytech_Projects/pfe_plankton_classif/LOOV/bottleneck_features.npy', 'wb'), bottleneck_features_train)

    save_model(model, "VGG16_model_bottle.h5")
